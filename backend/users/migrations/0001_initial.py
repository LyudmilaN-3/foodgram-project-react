    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(max_length=150, unique=True, validators=[api.validators.username_validation, api.validators.pattern_validation], verbose_name='Юзернейм пользователя')),
